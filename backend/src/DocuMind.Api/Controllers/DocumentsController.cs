...
using DocuMind.Api.Contracts.Documents;
using DocuMind.Application.Common.Interfaces;
using DocuMind.Application.Documents;
using DocuMind.Application.Documents.Commands.UploadDocument;
using DocuMind.Application.Documents.Models;
using DocuMind.Application.Documents.Queries.GetDocument;
using DocuMind.Application.Documents.Queries.ListDocuments;
using MediatR;
