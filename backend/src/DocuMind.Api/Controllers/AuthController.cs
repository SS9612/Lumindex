using DocuMind.Api.Contracts.Auth;
using DocuMind.Application.Authentication.Commands.Login;
using DocuMind.Application.Authentication.Commands.Register;
using DocuMind.Application.Authentication.Models;
using DocuMind.Application.Authentication.Queries.GetCurrentUser;
